      ...
      {isEditing ? (
        <div className="space-y-3">
          ...
          <input
            ...
            onChange={(e) =>
              setEditData({ ...editData, completionTime: e.target.value })
            }
        ...
        <div className="flex items-start gap-3">
          ...
          {/* Action buttons
              On desktop: show on hover (opacity-0 group-hover:opacity-100)
              On mobile: always visible (opacity-100) */}
          <div className="flex gap-1 opacity-100 lg:opacity-0 lg:group-hover:opacity-100 transition-opacity duration-150">
            <button
